...
def mean_square_2(arr, mean=[10000, 0]):
    sum = 0
...
print(mean_square(res1))
print(mean_square(res2))
print(mean_square(res3))
...
print(mean_square_2(test_1)) # error correction
print(mean_square_2(test_2)) # no error correction
